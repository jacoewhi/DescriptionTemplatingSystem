...
define("partName", "1398F");
define("partPattern", "F-");
define("rulePattern", "/[A-Z]\d+\s--\s\d+-\d+|[A-Z]\s--\s\d+-\d+/");
define("specialRulePattern", "/\*/");
define("testProduct", "F-4030-Q-H00AA");
...
<div class="container">
    <div class="row">
        <div class="col-lg-12" id="mainBody">
            <form class="col-lg-12" enctype="multipart/form-data" method="post" action="1398F.php" style="text-align: center">
                <h2 class="ui dividing header">1398F Specification Generation</h2>
                ...
                <div class="row">
                    ...
                    <input type="radio" id="1398F" name="series" value="1398F">
                    <label for="1398F">1398F</label><br />
                </div>
