...
define("partName", "TL-SeriesMotors");
define("partPattern", "(TL-A|TLY-A)(25|[1-4])(\d{2})(P|M|T)-(B|H)(J|K)(3|6)(2|4)(AA|AN)");
...
if (isset($_POST['series'])) {
    if ($_POST['series'] == partName) {
        $query = $db->prepare("SELECT * FROM products WHERE part_number LIKE 'TL%-A%'");
        $query->execute();
