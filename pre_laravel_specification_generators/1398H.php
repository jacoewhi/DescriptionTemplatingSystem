...
define("partName", "1398H");
define("partPattern", "H-");
define("rulePattern", "/[A-Z]\d+\s--\s\d+-\d+|[A-Z]\s--\s\d+-\d+/");
define("specialRulePattern", "/\*/");
define("testProduct", "H-2005-K-H00AA");
...
<div class="container">
    <div class="row">
        <div class="col-lg-12" id="mainBody">
            <form class="col-lg-12" enctype="multipart/form-data" method="post" action="1398H.php" style="text-align: center">
                <h2 class="ui dividing header">1398H Specification Generation</h2>
                ...
                <div class="row">
                    ...
                    <input type="radio" id="1398H" name="series" value="1398H">
                    <label for="1398H">1398H</label><br />
                </div>
