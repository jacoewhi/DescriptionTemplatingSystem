...
if (isset($_POST['series'])) {
    if ($_POST['series'] == partName) {
        $query = $db->prepare("SELECT * FROM products WHERE part_number LIKE '" . partPattern . "%'");
        $query->execute();
...
<div class="container">
    <div class="row">
        <div class="col-lg-12" id="mainBody">
            <form class="col-lg-12" enctype="multipart/form-data" method="post" action="Panelview5500.php" style="text-align: center">
                <h2 class="ui dividing header">Panelview5500 Specification Generation</h2>
                ...
                <div class="row">
                    ...
                    <input type="radio" id="Panelview5500" name="series" value="Panelview5500">
                    <label for="Panelview5500">Panelview5500</label><br />
                </div>
