...
define("partName", "9000X");
define("partDBPattern", "SVX-%");
define("partSimplePattern", "(SVX|SPX)");
define("partPattern", "(SVX|SPX)([FH0123456789]\d{2})(A)([012])-([245])(A)([124])([NB])(1)-?([ABCD]?[123456789ABEFJQ])?-?([ABCD]?[123456789ABEFJQ])?");
...
if (isset($_POST['series'])) {
	if ($_POST['series'] == partName) {
		$query = $db->prepare("SELECT * FROM products WHERE part_number LIKE 'SVX%' OR part_number LIKE 'SPX%'");
		$query->execute();
