...
define("partName", "160");
define("partDBPattern", "160%");
define("partSimplePattern", "(160-|160S-)");
define("partPattern", "(160S?-[AB]A[01][1234680])([NLPR])(SF1|PS1)(B1|P1)?");
...
if (isset($_POST['series'])) {
	...
	foreach ($query as $result) {
		...
		$matches = array();
		preg_match('/' . preg_replace('/-/', '', partPattern) . '/', preg_replace('/-/', '', $product->partNumber), $matches);
		$separatedNumber = "";
