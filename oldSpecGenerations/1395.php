...
define("testProduct", "1395-A61-C1-P10-P50");
...
if (isset($_POST['series'])) {
    if ($_POST['series'] == '1395DigitalDCDrive') {
        $query = $db->prepare("SELECT * FROM products WHERE part_number LIKE '1395%'");
        $query->execute();
    ...
    foreach ($query as $result) {
        if ($_POST['series'] == '1395DigitalDCDrive') {
            if (!preg_match("/1395-[A-Z]\d{2}N?-[A-Z]\w(-\w{2,})*/", $result['part_number'])) {
                continue;
            }
        }
        $product = new Product();
...
<div class="container">
    <div class="row">
        <div class="col-lg-12" id="mainBody">
            <form class="col-lg-12" enctype="multipart/form-data" method="post" action="1395.php" style="text-align: center">
                <h2 class="ui dividing header">1395 Specification Generation</h2>
                ...
                <div class="row">
                    ...
                    <input type="radio" id="1395DigitalDCDrive" name="series" value="1395DigitalDCDrive">
                    <label for="1395DigitalDCDrive">1395 Digital DC Drive</label><br />
                </div>
