...
if (isset($_POST['series'])) {
	if ($_POST['series'] === "powerflex70") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 1 AND name LIKE '20A%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex700") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 3 AND name LIKE '20B%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex700s") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 5 AND name LIKE '20D%' LIMIT 800000 OFFSET 2400000");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex753") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 19 AND name LIKE '20F%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex755") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 20 AND name LIKE '2_G%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex4") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 8 AND name LIKE '22A%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex4m") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 12 AND name LIKE '22F%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex40") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 9 AND name LIKE '22B%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex40p") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 11 AND name LIKE '22D%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === 'powerflex400') {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 10 AND name LIKE '22C%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex523") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 14 AND name LIKE '25A%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex525") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 15 AND name LIKE '25B%'");
		$query->execute();
		$query = $query->fetchAll();
	} else if ($_POST['series'] === "powerflex527") {
		$query = $db->prepare("SELECT * FROM listings WHERE manufacturer_product_line_id = 16 AND name LIKE '25C%'");
		$query->execute();
		$query = $query->fetchAll();
	}
...
<div class="container">
    <div class="row">
        <div class="col-lg-12" id="mainBody">
            <form class="col-lg-12" enctype="multipart/form-data" method="post" action="powerflex.php"
                ...
                <div class="row">
                    ...
                    <input type="radio" id="powerflex70" name="series" value="powerflex70">
                    <label for="powerflex70">Powerflex 70</label><br/>
                    <input type="radio" id="powerflex700" name="series" value="powerflex700">
                    <label for="powerflex700">Powerflex 700</label><br/>
                    <input id="powerflex700s" name="series" type="radio" value="powerflex700s">
                    <label for="powerflex700s">Powerflex 700s</label><br/>
                    <input type="radio" id="powerflex753" name="series" value="powerflex753">
                    <label for="powerflex753">Powerflex 753</label><br/>
                    <input type="radio" id="powerflex755" name="series" value="powerflex755">
                    <label for="powerflex755">Powerflex 755</label><br/>
                    <input type="radio" id="powerflex4" name="series" value="powerflex4">
                    <label for="powerflex4">Powerflex 4</label><br/>
                    <input type="radio" id="powerflex4m" name="series" value="powerflex4m">
                    <label for="powerflex4m">Powerflex 4M</label><br/>
                    <input type="radio" id="powerflex40" name="series" value="powerflex40">
                    <label for="powerflex40">Powerflex 40</label><br/>
                    <input type="radio" id="powerflex40p" name="series" value="powerflex40p">
                    <label for="powerflex40p">Powerflex 40P</label><br/>
                    <input type="radio" id="powerflex400" name="series" value="powerflex400">
                    <label for="powerflex400">Powerflex 400</label><br/>
                    <input type="radio" id="powerflex523" name="series" value="powerflex523">
                    <label for="powerflex523">Powerflex 523</label><br/>
                    <input type="radio" id="powerflex525" name="series" value="powerflex525">
                    <label for="powerflex525">Powerflex 525</label><br/>
                    <input type="radio" id="powerflex527" name="series" value="powerflex527">
                    <label for="powerflex527">Powerflex 527</label><br/>
                </div>
